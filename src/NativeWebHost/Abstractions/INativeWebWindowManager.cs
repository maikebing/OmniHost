...
/// <summary>
/// Manages the currently running host windows for an NativeWebHost application.
/// </summary>
public interface INativeWebWindowManager
{
    /// <summary>
    ...
    /// </summary>
    NativeWebWindowContext? GetWindowContext(string windowId);

    /// <summary>
    /// Opens an additional non-main window while the runtime is active.
    /// </summary>
    void OpenWindow(NativeWebWindowDefinition window);
