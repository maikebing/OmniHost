...
/// </summary>
public enum NativeWebWindowStyle
{
    /// <summary>
    ...
    /// <para>
    /// Use the <c>native-web-drag</c> HTML attribute on elements that should act as drag regions,
    /// and <c>nativeWeb.window.*</c> bridge methods to implement custom minimize / maximize /
    /// close controls from JavaScript.
    /// </para>
    /// <para>
    /// The CSS variable <c>--native-web-window-style</c> is set to <c>"frameless"</c> on the
