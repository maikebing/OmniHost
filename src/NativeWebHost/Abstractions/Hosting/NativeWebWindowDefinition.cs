...
/// </summary>
public sealed class NativeWebWindowDefinition
{
    /// <summary>
    /// Creates a new startup-window definition.
    /// </summary>
    public NativeWebWindowDefinition(string windowId, NativeWebHostOptions options)
    {
    ...
    /// </summary>
    public NativeWebHostOptions Options { get; }
}
