...
public sealed class GtkRuntime : IMultiWindowDesktopRuntime
{
    ...
    private sealed class RuntimeExecution
    {
        ...
        public void Run(NativeWebHostOptions options, IReadOnlyList<NativeWebWindowDefinition> additionalWindows)
        {
            ...
            uiThread.Name = "NativeWebHost-Gtk-UI";
            uiThread.Start();
            uiThread.Join();
        ...
        public void ThrowIfFailed()
        {
            ...
            throw new AggregateException("One or more NativeWebHost GTK windows failed.", failures);
        }
